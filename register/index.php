     ...
     <ul class="nav navbar-nav navbar-right">
        ...
        <form action ="home1.php" method ="POST">
            <table>
                ...
                <td> <i class="fa fa-user" style="font-size:25px;color:white"></i> ><a href="#" style="color:white;font-size:15px;top:-10px;" data-toggle="modal" data-target="#myModal"><input type="submit" class="button" value="SIGN IN"></a></td>
                </tr>
